...
namespace SparrowCMS
{
    ...
    {
        public static string GetReplacedModelContent(this ILabel label, string innerHtml, Document model, IEnumerable<IField> fields = null)
        {
            if (fields != null)
            {
